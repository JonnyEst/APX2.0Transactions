...
/**
 * Test for transaction WIKJT00102COTransaction

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT00102COTest.xml" })
public class WIKJT00102COTransactionTest {

	@Autowired
	private WIKJT00102COTransaction transaction;
